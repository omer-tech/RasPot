...
#looked at some PCAPS and got this data. Dissect a few pcaps to add more. Going to add more in the future.
...
formattedprint("Starting up Honey Pot python program...")
...
reactor.run()
formattedprint("Shutting down Honey Pot python program...")